...
- **⏳ Abnahme (T6, 27.08.):** `UpdateDeployer_v4.sfm` importieren → Instanz-Konfiguration → Tab **„Sicherheit“** → Token eintragen → WebApp-Anlage `deployer_token` = gleicher Wert (WebApp v0.0.178 deployed) → „Update anstoßen“ → erwartet `OK: UpdateDeployer v5 importiert`; Beweis: Modul-Version 5 in Anlagen-Registry/Status.
