...
| Version | Inhalt |
|---|---|
| v0.0.142 | **Root Cause „No item with that key“ (Modul v6):** getInstances4Module nur im Interface → ersetzt durch getInstalledInstances + getModuleId-Filter; verify_api_refs.py blockt API-Fallen dauerhaft. Details [[starface-telefonie-monitoring]]. |
