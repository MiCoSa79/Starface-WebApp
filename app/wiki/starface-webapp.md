...
|---|---|---|
| v1.0.19 | (27.08.) | fix(F59-Folge): Admin-Monitoring — Icon der neutralen Karte „Anlagen eingerichtet“ von Akzent-Rot #e94560 auf Blau #8ab4f8 (Axel-Feedback: auf der Seite ist Rot = Fehler-Semantik; die neutrale Gesamt-Kennzahl darf kein rotes Symbol tragen; Fehler-Karten behalten rot/grün). Tests 33/33 + 18/18 grün. |...[truncated]
