...
|---|---|---|
| v1.0.68 | (29.08.) | feat(F73): **Modul-Updates in zwei Varianten** — Untermenü „Modul-Updates ▸“; V1 `/admin/updates?inst_id=` (Such-Combobox, Leerzustand, Auswahl bleibt nach Aktionen), V2 `/admin/updates/modul?module=` (alle Anlagen mit nicht aktuellem Modul, Checkboxen + Alle/Nichts + Bulk-`/push-module`); `.msg/.empty/.muted/td form` global in admin.css; 36 neue v2-Tests (admin_updates_v2_test.py), Updates-Tests auf Param-Aufrufe umgestellt, Gesamtsuite grün; CDP-Belege f73_shots | `c8c3608` |
