...
- **TV-Kiosk (WebApp v0.0.125):** `?kiosk` allein lässt die obere Dashboard-Leiste (Zeitleiste/Refresh) sichtbar → Balken mitten im Dashboard beim Scrollen. Seit v0.0.125 setzen alle Links `?kiosk=tv` (Toolbar auch weg; Global-Datalink live, Version 7). „Powered by Grafana"-Badge unten rechts: fester Grafana-Standard, nicht abschaltbar.
