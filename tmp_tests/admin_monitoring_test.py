...
check("Kiosk blendet InfluxDB-Hinweis aus (.kiosk-hide)", "kiosk-hide" in body)
check("Kiosk-Refresh-Countdown vorhanden", 'id="refresh-countdown-kiosk-num"' in body)
check("Kiosk-Countdown fester Position (body.kiosk .kiosk-countdown)", "body.kiosk .kiosk-countdown" in body)
