#!/usr/bin/env python3
"""Builds the STARFACE 10.x TelefonieMonitoring .sfm as a JAR archive.
...
Output: module-monitoring/TelefonieMonitoring.sfm (and copy to app/modules/TelefonieMonitoring.sfm)
"""
import os
import re
import sys
...
OUT = os.path.join(ROOT, "TelefonieMonitoring.sfm")
MIRRORS = [
    os.path.join(ROOT, "..", "app", "modules", "TelefonieMonitoring.sfm"),
]
